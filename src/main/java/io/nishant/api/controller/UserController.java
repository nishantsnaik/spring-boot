package io.nishant.api.controller;
...
import io.nishant.api.constants.URI;
...
/*
 * @RestController removes the need for these 2:
 * @Controller // using this removes the need to annotate with @Component
